# Script: Generar Esquema SQL del CRM
# Descripción: Genera el DDL completo para implementar la base de datos CRM diseñada.
...
$outputPath = "$PSScriptRoot\..\resources\crm_schema.sql"
$sqlOutput | Out-File -FilePath $outputPath -Encoding utf8
Write-Host "Esquema SQL generado exitosamente en: $outputPath" -ForegroundColor Green
